	...
	*/
	...
	dialog.onok = function (){
	    ...
	    if( !oNode ) {//新建
	        try {
	            ...
	            for(var i=0;i<trLength;i++)
	            {
	                ...
	                if(inputs.length>0)
	                {
	                    ...
	                    html += '<input id="'+$G('param_name').value+'" name="'+$G('param_name').value+'" value="'+inputs[1].value+'" '+sChecked+' type="checkbox"/>'+inputs[1].value+'&nbsp;';
	                }
	            }
	            ...
	            html = '{|-<span myplugins="'+thePlugins+'" id="'+$G('param_name').value+'" name="'+$G('param_name').value+'" param_namechn="'+$G('param_namechn').value+'" datadefault="'+(hasChecked?hasChecked:"")+'">'
						+ html
						+ '</span>-|}';
            ...
            oNode.setAttribute('datadefault',(hasChecked?hasChecked:""));
